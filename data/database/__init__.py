...
def database_init():
    ...
    with sqlite3.connect(_DB_FILE) as conn:
        ...
        cursor.execute("""CREATE TABLE SecretKeys (secret VARCHAR(200))""")

        print('Insert values')
        cursor.execute("INSERT OR IGNORE INTO Roles VALUES (1, 'User'), (2, 'Admin')")
        cursor.execute("INSERT OR IGNORE INTO UserAccessLevel VALUES (1, 'Read'), (2, 'Full Control')")
        cursor.execute("""INSERT INTO Users (username, email, password_hash, user_role, is_active) VALUES
                    ('alice', 'alice@example.com', 'qwerty_1', 1, 1),
                    ('bob', 'bob@example.com', 'qwerty_2', 2, 1),
                    ('charlie', 'charlie@example.com', 'qwerty_3', 1, 1),
                    ('dave', 'dave@example.com', 'qwerty_4', 1, 0),
                    ('eve', 'eve@example.com', 'qwerty_5', 1, 1)""")
        cursor.execute("""INSERT INTO `Categories`  (category_name, is_private, is_locked) VALUES 
                    ...
                    ('Tech Support', 0, 0),
                    ('Private Forum', 1, 0)""")
        cursor.execute("""INSERT INTO `CategoryAccess` VALUES (1, 1, 1),(2, 1, 2),(3, 1, 1),(4, 5, 1),(5, 2, 1)""")
        ...
        cursor.execute("INSERT INTO `VoteTypes` VALUES (1, 'Upvote'),(2, 'Downvote')")
        cursor.execute("INSERT INTO `Votes` (user_id, reply_id, vote_type) VALUES (1, 1, 1),(2, 2, 1),(3, 3, 1),(4, 4, 2),(5, 5, 2)")
